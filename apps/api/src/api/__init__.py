...
from api.routes import auth, chat, graph, health, history, pr_reviews, repos, understanding, webhooks
...
def create_app() -> FastAPI:
    ...
    app.include_router(understanding.router, prefix="/repos", tags=["understanding"])
